...
export default function Home() {
  ...
  async function getPhotos() {
    const photosRes = await axios.get("search/photos?query=African");
    setPhotos(photosRes.data.results);
    console.log(photosRes.data.results);
    setloading(false);
  }
  ...
  return (
    <>
      ...
      <SearchBanner showSearch={true} loading={loading} photos={photos} />
